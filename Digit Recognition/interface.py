        ...
        if event.type == MOUSEBUTTONUP:
            ...
            if (not(len(number_xcord) <= 0 or len(number_xcord) <= 0)):
                ...
                if PREDICT:
                    ...
                    # top line
                    pygame.draw.line(DISPLAY_SURFACE, BLUE, (rect_min_x, rect_min_y), (rect_max_x, rect_min_y), 3)
                    # bottom line
                    pygame.draw.line(DISPLAY_SURFACE, BLUE, (rect_min_x, rect_max_y), (rect_max_x, rect_max_y), 3)
                    # left line
                    pygame.draw.line(DISPLAY_SURFACE, BLUE, (rect_min_x, rect_min_y), (rect_min_x, rect_max_y), 3)
                    # right line
                    pygame.draw.line(DISPLAY_SURFACE, BLUE, (rect_max_x, rect_min_y), (rect_max_x, rect_max_y), 3)
